import os.path
from dataset_implicit_approach_efficiency import Grasp_Dataset, GraspNormalization, GraspAugmentation, PreTransformBallBox, SubsampleBall
from vn_grasp_ball_rss2 import EdgeGrasp
import torch
import time
...
def main(args):
    ...
    # set up the model
    edge_grasper = EdgeGrasper(device=1, root_dir='./vn_clutter_max2', sample_num=args.sample_num, lr=1e-7, load=args.load,
